...
\begin{definition}[Extension and restriction of exponents]
  ...
  Let $I$ be a finite set of variables.  Extension by zero is the map
  \[
    \iota_*\colon A((t_i^\Gamma))_{i\in I}
      \longrightarrow A((t_i^{\mathbb{R}}))_{i\in I}
  \]
  whose coefficient at $d\in\mathbb{R}^I$ is the coefficient of the original
  series when every $d_i$ lies in $\Gamma$, and is zero otherwise.  It is an
  ...
  to $\Gamma^I$ is inverse to extension on this set.
\end{definition}
...
\begin{theorem}[The main Novikov descent theorem]
