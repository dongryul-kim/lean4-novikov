...
\begin{lemma}[Additive Novikov \v{C}ech cocycles are coboundaries]
  ...
  \[
    \pi_{13}^\ast x=\pi_{23}^\ast x+\pi_{12}^\ast x.
  \]
  Define the first-axis restriction $y\in H((t^{\mathbb{R}}))$ by
  $y_d=x_{(d,0)}$.  Then
  \[
    x=\pi_1^\ast y-\pi_2^\ast y.
  \]
\end{lemma}
...
\begin{lemma}[Endomorphism-valued additive cocycles]
  ...
  \[
    ...
    \pi_{13}^\ast\delta=\pi_{23}^\ast\delta+\pi_{12}^\ast\delta,
  \]
  then there exists $\eta\in\operatorname{End}(C_1(P))$ such that
  \[
    \delta=\pi_1^\ast\eta-\pi_2^\ast\eta.
  \]
...
\begin{lemma}[Normalization of a constant underlying module]
  ...
  \[
    \pi_{23}^\ast\psi\circ\pi_{12}^\ast\psi=\pi_{13}^\ast\psi.
  \]
...
\begin{proof}
  ...
  \[
    (1+\pi_{23}^\ast\delta)(1+\pi_{12}^\ast\delta)
      =1+\pi_{13}^\ast\delta.
  \]
  ...
  \[
    \pi_{13}^\ast\delta
      =\pi_{23}^\ast\delta+\pi_{12}^\ast\delta.
  \]
  ...
  $\pi_2^\ast\eta\circ\pi_1^\ast\eta=0$.  Thus
  \[
    \xi=1+\eta,
    \qquad
    \xi^{-1}=1-\eta,
  ...
  \[
    \psi
      =1+\pi_1^\ast\eta-\pi_2^\ast\eta
      =(1-\pi_2^\ast\eta)(1+\pi_1^\ast\eta)
      =\pi_2^\ast(\xi^{-1})\circ\pi_1^\ast(\xi).
  \]
